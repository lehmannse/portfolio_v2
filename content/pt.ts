...
const pt: PortfolioContent = {
  ...
  about: {
    ...
    skills: {
      ...
      highlights: [
        { text: 'tecnicamente sólidas', style: 'normal' },
        { text: 'genuinamente úteis', style: 'normal' },
      ],
    },
  ...
  projectsHeader: 'Projetos em Destaque',
  projects: [
    {
      name: 'Now Row LP',
      description:
    ...
    },
    {
      ...
      description:
        'Aplicativo de gerenciamento de aluguel de carros, permitindo registro de veículos, clientes, aluguéis e pagamentos. Consultas com múltiplas condicionais e geração de 3 tipos de relatório.',
      pic: '/pascal.png',
  ...
  moreProjectsHeader: 'Mais Projetos',
  extraProjects: [
    {
  ...
  extraProjectsBtn: { show: 'Mostrar', more: 'mais', less: 'menos' },
  moreProjectsTable: {
    name: 'Nome',
    type: 'Tipo',
